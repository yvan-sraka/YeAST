...
QMAKE    = /usr/bin/qmake
yeast.xcodeproj/project.pbxproj: yeast.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o yeast.xcodeproj/project.pbxproj yeast.pro
