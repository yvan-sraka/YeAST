...
QMAKE    = /usr/bin/qmake
qmce.xcodeproj/project.pbxproj: qmce.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o qmce.xcodeproj/project.pbxproj qmce.pro
